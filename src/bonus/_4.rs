...
//!
//! <audio style="width: 100%" title="Building as a community" controls preload=metadata
//! src="https://www.podtrac.com/pts/redirect.mp3/cdn.newrustacean.com/file/newrustacean/bonus/4.mp3"></audio>
//!
//! ## Notes
//!
//! Sometimes life goes crazy and I don't have time to do all the technical writing required for a full episode, but I
//! can't get Rust off my mind, so I record an episode like this one. Where I talk a bit about how versatile Rust is
//! and suggest some surprising ways you might be able to use it.
//!
//! ## Links
//!
//!   - [Rust 1.8] blog post
...
//!
//! [Rust 1.8]: https://blog.rust-lang.org/2016/04/14/Rust-1.8.html
